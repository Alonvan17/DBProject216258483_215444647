...
תיאור כללי:
מתבצעת קריאה לפונקציה fn_commander_performance() והנתונים עוברים בלולאה. מוצגת התפלגות המפקדים לפי רמות ניסיון, ומוצג סיכום סטטיסטי של מספר המפקדים בכל רמה.
